...
def _welcome_shell(*, preheader: str, content_html: str) -> str:
    ...
    glyph = (
        ...
        'style="display:block;">'
        '<path d="M 16 2 A 14 14 0 0 1 16 30" stroke="#efece4" '
        'stroke-opacity="0.34" stroke-width="1.6" stroke-linecap="round"/>'
        '<path d="M 16 6 A 10 10 0 0 1 16 26" stroke="#efece4" '
        'stroke-opacity="0.72" stroke-width="2" stroke-linecap="round"/>'
        '<path d="M 16 11 A 5 5 0 0 1 16 21" stroke="#efece4" '
        'stroke-width="2.4" stroke-linecap="round"/>'
        f'<circle cx="16" cy="16" r="2.4" fill="{PALETTE["accent"]}"/>'
        "</svg>"
    )
